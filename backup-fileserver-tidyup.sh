...
## backup media files to backup device 1
  ...
  rsync $fileserver/books/ $backup1/books -vah --delete-after >> $backup1/backuplog.log
  
  echo 'Backing up documentaries'
  echo '----------------------------------------------------------' >> $backup1/backuplog.log
  echo 'Backing up documentaries' >> $backup1/backuplog.log
  rsync $fileserver/documentary/ $backup1/documentary -vah --delete-after >> $backup1/backuplog.log
  
  echo 'Backing up films'
  echo '----------------------------------------------------------' >> $backup1/backuplog.log
  echo 'Backing up films' >> $backup1/backuplog.log
  rsync $fileserver/films/ $backup1/films -vah --delete-after >> $backup1/backuplog.log
  
  echo 'Backing up tv comedies'
  echo '----------------------------------------------------------' >> $backup1/backuplog.log
  echo 'Backing up comedies' >> $backup1/backuplog.log
  rsync $fileserver/comedy/ $backup1/comedy -vah --delete-after >> $backup1/backuplog.log
  
  echo 'Backing up dramas'
  echo '----------------------------------------------------------' >> $backup1/backuplog.log
  echo 'Backing up dramas' >> $backup1/backuplog.log
  rsync $fileserver/drama/ $backup1/drama -vah --delete-after >> $backup1/backuplog.log
  
  echo 'backing up music'
  echo '----------------------------------------------------------' >> $backup1/backuplog.log
  echo 'Backing up music' >> $backup1/backuplog.log
  rsync $fileserver/music/ $backup1/music -vah --delete-after >> $backup1/backuplog.log
  
  echo 'Backing up scifi'
  echo '----------------------------------------------------------' >> $backup1/backuplog.log
  echo 'Backing up scifi' >> $backup1/backuplog.log
  rsync $fileserver/scifi/ $backup1/scifi -vah --delete-after >> $backup1/backuplog.log
...
## backup other user files to backup device 2
  ...
  rsync $fileserver/users/ $backup2/users -vah --delete-after >> $backup2/backuplog.log
  
  echo 'Backing up software'
  echo '----------------------------------------------------------' >> $backup2/backuplog.log
  echo 'Backing up software' >> $backup2/backuplog.log
  rsync $fileserver/software/ $backup2/software -vah --delete-after >> $backup2/backuplog.log

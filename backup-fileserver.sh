...
#	rsync $fileserver/$i/ $backup1/$i -rtv >> $backup1/backuplog.log
#done	
...
do
        ...
        rsync $fileserver/$i/ $backup2/$i -rtv >> $backup2/backuplog.log
done
...
do
        ...
        rsync $fileserver/$i/ $backup3/$i -rtv >> $backup3/backuplog.log
done
